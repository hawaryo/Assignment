  ...
  return (
      ...
      <section className={styles.questionsection}>
        ...
        <details>
            ...
            <i className={`faq-toggle bi bi-chevron-right ${styles.arrow}`}></i>
            </summary>
          ...
          <details>
            <summary>
              <p>4. Ac odio tempor orci dapibus. Aliquam eleifend mi in nulla?</p>
              <i className={`faq-toggle bi bi-chevron-right ${styles.arrow}`}></i>
            </summary>
            Dolor sit amet consectetur adipiscing elit pellentesque habitant
            morbi. Id interdum velit laoreet id donec ultrices. Fringilla
          ...
          <details>
            <summary>
              <p>5. Tempus quam pellentesque nec nam aliquam sem et tortor consequat?</p>
              <i className={`faq-toggle bi bi-chevron-right ${styles.arrow}`}></i>
            </summary>
